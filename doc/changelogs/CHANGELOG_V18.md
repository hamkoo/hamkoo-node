...
## 2023-04-11, Version 18.16.0 'Hydrogen' (LTS), @danielleadams
...
* **src**:
  ...
  * **(SEMVER-MINOR)** add initial support for single executable applications (Darshan Sen) [#45038](https://github.com/nodejs/node/pull/45038)
* **stream**:
